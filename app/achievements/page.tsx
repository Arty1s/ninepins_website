...
function HeroSection() {
  return (
    <section className="relative overflow-hidden bg-[linear-gradient(135deg,#031225_0%,#061b35_48%,#031225_100%)] pt-[106px]">
    ...
    <SectionSurface className="mt-6">
      <div className="grid gap-8 lg:grid-cols-[1.05fr_.95fr]">
        <div>
          ...
          <p className="mt-5 max-w-3xl text-base leading-8 text-[#c2d0e4]">
            ...
            {clubHighlights.map((item) => (
              <div key={item.title} className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm leading-6 text-[#9fb0c8]">{item.text}</p>
                </div>
              </div>
            ))}
          </div>
    ...
    <SectionSurface className="mt-6">
      ...
      <div className="mt-5 grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6">
        {numberStats.map((item) => (
          <div key={item.label} className="rounded-2xl bg-[linear-gradient(180deg,rgba(10,35,70,.56),rgba(8,24,48,.36))] p-5 shadow-[0_12px_32px_rgba(0,0,0,.16),inset_0_1px_0_rgba(255,255,255,.035)]">
            <item.icon className="h-8 w-8 text-[#1688ff]" strokeWidth={1.7} />
            <p className="mt-4 font-display text-3xl font-black">{item.value}</p>
            <p className="mt-1 text-sm leading-5 text-[#a9bad3]">{item.label}</p>
          </div>
        ))}
      </div>
    </SectionSurface>
    ...
    <SectionSurface className="mt-6">
      <div className="grid gap-8 lg:grid-cols-[.9fr_1.1fr_.55fr]">
        <div>
          ...
          <p className="mt-4 text-sm leading-7 text-[#c2d0e4]">
            ...
            {[
              ...
              <div key={title} className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-[#9fb0c8]">{text}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="rounded-2xl bg-[linear-gradient(180deg,rgba(10,35,70,.52),rgba(8,24,48,.32))] p-5 shadow-[0_14px_42px_rgba(0,0,0,.16),inset_0_1px_0_rgba(255,255,255,.035)]">
          ...
          <p className="mt-1 text-sm text-[#9fb0c8]">Hlohovec</p>
  ...
  return (
    <section className="container-page pb-16 pt-6">
      <div className="grid gap-6 lg:grid-cols-[.95fr_1.05fr]">
        <div className="overflow-hidden rounded-2xl bg-[linear-gradient(180deg,rgba(10,29,58,.74),rgba(8,23,46,.54))] shadow-[0_20px_70px_rgba(0,0,0,.22),inset_0_1px_0_rgba(255,255,255,.035)]">
          <div className="grid gap-6 p-6 md:grid-cols-[170px_1fr]">
            ...
            <blockquote className="flex flex-col justify-center">
              ...
              <p className="text-sm text-[#9fb0c8]">kolkársky klub</p>
            </blockquote>
          </div>
        </div>
...
function SectionSurface({ children, className = "" }: { children: React.ReactNode; className?: string }) {
  return (
    <section className={`relative overflow-hidden py-10 ${className}`}>
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_18%_20%,rgba(22,136,255,.06),transparent_34%),radial-gradient(circle_at_86%_18%,rgba(22,136,255,.05),transparent_30%)]" />
...
function SportVisual({ title, image, primary = false }: { title: string; image: string; primary?: boolean }) {
  return (
    <div className="text-center">
      <p className={`text-xs font-black uppercase tracking-[0.14em] ${primary ? "text-[#1688ff]" : "text-white/72"}`}>{title}</p>
      <div className="relative mx-auto mt-4 h-40 w-full max-w-[220px] overflow-hidden rounded-2xl bg-[#061a33]">
